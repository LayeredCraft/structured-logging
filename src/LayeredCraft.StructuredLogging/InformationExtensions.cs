...
public static class InformationExtensions
{
    ...
    extension(ILogger logger)
    {
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2>(string? message, T0? propertyValue0, T1? propertyValue1,
            T2? propertyValue2)
        {
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2, T3>(string? message, T0? propertyValue0, T1? propertyValue1,
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2, T3, T4>(string? message, T0? propertyValue0, T1? propertyValue1,
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2, T3, T4, T5>(string? message, T0? propertyValue0, T1? propertyValue1,
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1>(Exception? exception, string? message, T0? propertyValue0, T1? propertyValue1)
        {
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2>(Exception? exception, string? message, T0? propertyValue0, T1? propertyValue1,
            T2? propertyValue2)
        {
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2, T3>(Exception? exception, string? message, T0? propertyValue0, T1? propertyValue1,
            T2? propertyValue2, T3? propertyValue3)
        {
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2, T3, T4>(Exception? exception, string? message, T0? propertyValue0, T1? propertyValue1,
            T2? propertyValue2, T3? propertyValue3, T4? propertyValue4)
        {
        ...
        /// </code>
        /// </example>
        public void Information<T0, T1, T2, T3, T4, T5>(Exception? exception, string? message, T0? propertyValue0, T1? propertyValue1,
            T2? propertyValue2, T3? propertyValue3, T4? propertyValue4, T5? propertyValue5)
        {
