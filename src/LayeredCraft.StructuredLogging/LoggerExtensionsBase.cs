...
internal static class LoggerExtensionsBase
{
    ...
    extension(ILogger logger)
    {
        ...
        internal void LogMessage(LogLevel logLevel, Exception? exception, string? message)
        {
        ...
        internal void LogMessage<T>(LogLevel logLevel, Exception? exception, string? message,
            T? propertyValue)
        {
            if (logger.IsEnabled(logLevel))
        ...
        internal void LogMessage<T0, T1>(LogLevel logLevel, Exception? exception,
        ...
        internal void LogMessage<T0, T1, T2>(LogLevel logLevel, Exception? exception,
        ...
        internal void LogMessage<T0, T1, T2, T3>(LogLevel logLevel, Exception? exception,
        ...
        internal void LogMessage<T0, T1, T2, T3, T4>(LogLevel logLevel, Exception? exception,
        ...
        internal void LogMessage<T0, T1, T2, T3, T4, T5>(LogLevel logLevel, Exception? exception,
