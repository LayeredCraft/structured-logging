...
public static class ScopeExtensions
{
    ...
    extension(ILogger logger)
    {
        ...
        /// </code>
        /// </example>
        public IDisposable BeginScope<T0, T1>(string name0, T0 value0, string name1, T1 value1)
        {
            return logger.BeginScope(new Dictionary<string, object?>
            {
                [name0] = value0,
        ...
        /// <returns>An IDisposable that should be disposed to end the scope.</returns>
        public IDisposable BeginScope<T0, T1, T2>(string name0, T0 value0, string name1, T1 value1, string name2, T2 value2)
        {
            return logger.BeginScope(new Dictionary<string, object?>
            {
                [name0] = value0,
        ...
        /// <returns>An IDisposable that should be disposed to end the scope.</returns>
        public IDisposable BeginScope<T0, T1, T2, T3>(string name0, T0 value0, string name1, T1 value1, string name2, T2 value2, string name3, T3 value3)
        {
            return logger.BeginScope(new Dictionary<string, object?>
            {
                [name0] = value0,
        ...
        /// <returns>An IDisposable that should be disposed to end the scope.</returns>
        public IDisposable BeginScope<T0, T1, T2, T3, T4>(string name0, T0 value0, string name1, T1 value1, string name2, T2 value2, string name3, T3 value3, string name4, T4 value4)
        {
            return logger.BeginScope(new Dictionary<string, object?>
            {
                [name0] = value0,
        ...
        /// <returns>An IDisposable that should be disposed to end the scope.</returns>
        public IDisposable BeginScope<T0, T1, T2, T3, T4, T5>(string name0, T0 value0, string name1, T1 value1, string name2, T2 value2, string name3, T3 value3, string name4, T4 value4, string name5, T5 value5)
        {
            return logger.BeginScope(new Dictionary<string, object?>
            {
                [name0] = value0,
        ...
        /// </code>
        /// </example>
        public IDisposable BeginCallerScope([CallerMemberName] string memberName = "",
        ...
        /// </code>
        /// </example>
        public IDisposable BeginCallerScope<T>(string name, T value,
        ...
        /// </code>
        /// </example>
        public IDisposable BeginRequestScope(string requestId, string? userId = null)
        {
        ...
        /// </code>
        /// </example>
        public IDisposable BeginOperationScope(string operationName, string? operationId = null)
        {
            var scope = new Dictionary<string, object?>
            {
        ...
        /// </code>
        /// </example>
        public IDisposable BeginCorrelationScope(string correlationId, string? parentId = null)
        {
            var scope = new Dictionary<string, object?>
            {
        ...
        /// </code>
        /// </example>
        public IDisposable BeginScopeWith(object state)
        {
